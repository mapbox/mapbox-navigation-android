...
with codecs.open(licensePath, 'w', encoding='utf-8') as licenseFile:
    ...
    writeToFile(licenseFile, "/libnavigation-tripdata/build/reports/licenses/licenseReleaseReport.json")
    licenseFile.write("\n\n#### Navigation Voice SDK module\n")
    writeToFile(licenseFile, "/libnavigation-voice/build/reports/licenses/licenseReleaseReport.json")
...
removeLicenseHtmlFileForModule("libnavigation-tripdata")
removeLicenseHtmlFileForModule("libnavigation-voice")
removeLicenseHtmlFileForModule("libnavigation-copilot")
