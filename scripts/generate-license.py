...
with codecs.open(licensePath, 'w', encoding='utf-8') as licenseFile:
    ...
    licenseFile.write("\n\n#### Navigation UI Voice Feedback SDK module\n")
    writeToFile(licenseFile, "/libnavui-voicefeedback/build/reports/licenses/licenseReleaseReport.json")
...
removeLicenseHtmlFileForModule("libnavigation-voicefeedback")
...
removeLicenseHtmlFileForModule("libnavui-voicefeedback")
