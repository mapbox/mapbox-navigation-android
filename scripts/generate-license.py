...
with codecs.open(licensePath, 'w', encoding='utf-8') as licenseFile:
    ...
    writeToFile(licenseFile, "/driver-notification/build/reports/licenses/licenseReleaseReport.json")
    licenseFile.write("\n\n#### Nav SDK Search module\n")
    writeToFile(licenseFile, "/search/build/reports/licenses/licenseReleaseReport.json")
...
removeLicenseHtmlFileForModule("driver-notification")
removeLicenseHtmlFileForModule("search")
