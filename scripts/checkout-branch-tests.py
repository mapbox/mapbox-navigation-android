...
class TestCheckoutBranch(unittest.TestCase):
    ...
    def test_get_latest_tag(self):
        ...
        self.assertEqual(checkout_branch_utils.get_latest_tag(tags), 'v2.12.0-rc.1')

    def test_get_snapshot_branch_with_latest_alpha_tag(self):
        self.assertEqual(checkout_branch_utils.get_snapshot_branch('v2.12.0-alpha.1'), 'main')

    def test_get_snapshot_branch_with_latest_beta_tag(self):
        self.assertEqual(checkout_branch_utils.get_snapshot_branch('v2.12.0-beta.1'), 'main')

    def test_get_snapshot_branch_with_latest_rc_tag(self):
        self.assertEqual(checkout_branch_utils.get_snapshot_branch('v2.12.0-rc.1'), 'release-v2.12')

    def test_get_snapshot_branch_with_latest_stable_tag(self):
        self.assertEqual(checkout_branch_utils.get_snapshot_branch('v2.12.0'), 'main')
