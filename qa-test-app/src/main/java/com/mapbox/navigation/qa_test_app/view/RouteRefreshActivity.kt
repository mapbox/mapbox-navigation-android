                ...
                RouteLineResources.Builder()
                    .routeLineColorResources(
                        RouteLineColorResources.Builder()
                            .alternativeRouteDefaultColor(Color.parseColor("#FF0000"))
                            .alternativeRouteHeavyCongestionColor(Color.parseColor("#00FF00"))
                            .alternativeRouteLowCongestionColor(Color.parseColor("#0000FF"))
                            .alternativeRouteModerateCongestionColor(Color.parseColor("#FFFF00"))
                            .alternativeRouteSevereCongestionColor(Color.parseColor("#FF00FF"))
                            .alternativeRouteUnknownCongestionColor(Color.parseColor("#00FFFF"))
                            .build()
                    )
                    .build()
            )
