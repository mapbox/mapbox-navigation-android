...
class DropInNavigationView @JvmOverloads constructor(
    ...
    private val replayViewModel: DropInReplayViewModel by lazyViewModel()
    private val cameraViewModel: DropInNavigationCameraViewModel by lazyViewModel()
    ...
    init {
        ...
        attachResumed(
            ...
            DropInActiveGuidance(binding.stop, binding.maneuverView, binding.tripProgressView),
