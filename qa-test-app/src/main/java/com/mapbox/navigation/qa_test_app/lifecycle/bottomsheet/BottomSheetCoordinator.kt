...
class BottomSheetCoordinator(viewGroup: ViewGroup) : UICoordinator<ViewGroup>(viewGroup) {
        ...
        combine(
            ...
            when {
                tripSessionState == TripSessionState.STARTED &&
                    ...
                    TripProgressViewBinder()
                }
                tripSessionState == TripSessionState.STOPPED &&
                    routesUpdatedResult.routes.isNotEmpty() -> {
                    RoutePreviewViewBinder(routesUpdatedResult.routes)
                }
