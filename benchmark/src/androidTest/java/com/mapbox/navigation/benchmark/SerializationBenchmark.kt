...
class SerializationBenchmark {
    ...
    fun serialize_from_bytebuffer() {
        ...
        val dataRef = putTextToDirectByteBuffer(json, StandardCharsets.UTF_8)
        benchmarkRule.measureRepeated {
            this.runWithTimingDisabled { dataRef.buffer.position(0) }
    ...
    private fun putTextToDirectByteBuffer(textJson: String, charset: Charset): DataRef {
        ...
        dataRef.buffer.put(json)
        dataRef.buffer.position(0)
        return dataRef
    }
