...
class MapboxCustomStyleActivity : AppCompatActivity(), OnMapLongClickListener {
    ...
    private val routeProgressObserver = object : RouteProgressObserver {
        override fun onRouteProgressChanged(routeProgress: RouteProgress) {
            ...
            // Maneuver: The distance remaining to finish the maneuver and upcoming maneuvers
            // is driven by route progress updates.
            // Passing the route progress to the MapboxManeuverApi generates the data
            // for updating the view. The result must be rendered by the MapboxManeuverView.
