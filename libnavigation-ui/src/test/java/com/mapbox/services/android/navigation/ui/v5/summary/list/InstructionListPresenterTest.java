...
import com.mapbox.navigation.ui.v5.summary.list.InstructionListPresenter;
import com.mapbox.navigation.ui.v5.summary.list.InstructionListView;
...
public class InstructionListPresenterTest extends BaseTest {
  ...
  private RouteProgress buildRouteProgress() throws Exception {
    Route route = buildTestDirectionsRoute();
