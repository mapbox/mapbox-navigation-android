...
import com.mapbox.navigation.ui.voice.SpeechAnnouncement;
...
public class NavigationViewModel extends AndroidViewModel {
  ...
  MutableLiveData<Route> retrieveRoute() {
    return route;
  }
  ...
  private void initializeNavigationSpeechPlayer(NavigationViewOptions options) {
    ...
    boolean isVoiceLanguageSupported = options.route().getVoiceLanguage() != null;
  ...
  private FasterRouteListener fasterRouteListener = new FasterRouteListener() {
    @Override
    public void fasterRouteFound(Route route) {
      updateRoute(route);
    }
  };
  ...
  private void updateReplayEngine(Route route) {
  ...
  private void sendEventOnRerouteAlong(Route route) {
