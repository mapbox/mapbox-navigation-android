...
public class FeedbackBottomSheet extends BottomSheetDialogFragment implements Animator.AnimatorListener {
  ...
  /**
   * @deprecated New feedback design changes the flow. The original detail flow is deprecated.
   * Please use {@link FeedbackDetailsFragment}.
  ...
  public void setFeedbackBottomSheetListener(FeedbackBottomSheetListener feedbackBottomSheetListener) {
    if (feedbackBottomSheetListenerClass == null
            || feedbackBottomSheetListenerClass.isInstance(feedbackBottomSheetListener)) {
