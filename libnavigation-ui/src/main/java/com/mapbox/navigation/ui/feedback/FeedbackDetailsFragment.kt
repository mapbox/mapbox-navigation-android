 ...
 */
class FeedbackDetailsFragment private constructor() : DialogFragment() {
    ...
    private fun getFeedbackSubTypes(feedbackItem: CachedNavigationFeedbackEvent): List<FeedbackSubTypeItem> {
