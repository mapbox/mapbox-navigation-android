 ...
 * hook into route related events occurring in {@link NavigationView}.
 */
public interface RouteListener {
  ...
  /**
   * Will trigger when a new {@link Route} has been retrieved post off route.
   * <p>
   ...
   * @since 0.8.0
   */
  void onRerouteAlong(Route route);

  /**
   * Will trigger if the request for a new {@link Route} fails.
   *
   * @since 0.8.0
   */
  ...
  /**
   * Will trigger when a user has arrived at a given waypoint along a {@link Route}.
   * <p>
