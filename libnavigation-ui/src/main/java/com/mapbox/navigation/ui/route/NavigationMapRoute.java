...
public class NavigationMapRoute implements LifecycleObserver {
   ...
   *
   * @param route the directions route which you'd like to display on the map
   * @since 0.4.0
   */
  ...
  /**
   * Provide a list of {@link Route}s, the primary route will default to the first route
   ...
   * @since 0.8.0
   */
  public void addRoutes(@NonNull @Size(min = 1) List<Route> directionsRoutes) {
   ...
   * <p>
   * If a new route is given to {@link MapboxNavigation#startNavigation(Route)}, this
