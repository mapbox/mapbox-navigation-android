...
class NavigationFeedbackOptions(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (enableDetailedFeedbackAfterNavigation != other.enableDetailedFeedbackAfterNavigation) return false
    ...
    class Builder() {
         ...
         *  @return this [Builder]
         */
        fun enableDetailedFeedbackAfterNavigation(enableDetailedFeedbackAfterNavigation: Boolean): Builder =
            apply { this.enableDetailedFeedbackAfterNavigation = enableDetailedFeedbackAfterNavigation }
