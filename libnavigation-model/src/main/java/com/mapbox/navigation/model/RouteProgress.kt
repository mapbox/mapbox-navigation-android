...
data class RouteProgress constructor(
    ...
    class Builder {
        ...
        private var currentLegProgress: com.mapbox.navigation.model.RouteLegProgress? = null
        ...
        private var voiceInstruction: com.mapbox.navigation.model.VoiceInstruction? = null
        private var bannerInstruction: com.mapbox.navigation.model.BannerInstruction? = null
        private var currentState: com.mapbox.navigation.model.RouteProgressState? = null
        ...
        fun currentLegProgress(currentLegProgress: com.mapbox.navigation.model.RouteLegProgress) =
        ...
        fun voiceInstruction(voiceInstruction: com.mapbox.navigation.model.VoiceInstruction?) =
                apply { this.voiceInstruction = voiceInstruction }

        fun bannerInstruction(bannerInstruction: com.mapbox.navigation.model.BannerInstruction?) =
                apply { this.bannerInstruction = bannerInstruction }

        fun currentState(currentState: com.mapbox.navigation.model.RouteProgressState?) =
        ...
        fun build(): RouteProgress {
            ...
            val routeLegProgressBuilder = com.mapbox.navigation.model.RouteLegProgress.Builder()
            ifNonNull(leg) {
