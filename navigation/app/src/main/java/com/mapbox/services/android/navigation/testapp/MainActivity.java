...
import com.mapbox.services.android.navigation.testapp.activity.navigationui.SearchDetailsViewActivity;
...
public class MainActivity extends AppCompatActivity implements PermissionsListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final List<SampleItem> samples = new ArrayList<>(Arrays.asList(
      ...
      new SampleItem(
        getString(R.string.title_search_details_view),
        getString(R.string.description_search_details_view),
        SearchDetailsViewActivity.class
      )
    ));
