...
//    double stepDuration = routeProgress.currentLegProgress().getCurrentStepProgress().getDurationRemaining();
//
//    for (int i = 10; i > 0; i--) {
...
//    double stepDistance = routeProgress.currentLegProgress().getCurrentStepProgress().getDistanceRemaining();
//
//    for (int i = 10; i > 0; i--) {
//      Milestone milestone = new StepMilestone.Builder()
//        .setTrigger(
...
//    double stepDistanceTotal = routeProgress.currentLegProgress().getCurrentStep().getDistance();
//
//    for (int i = 10; i > 0; i--) {
//      Milestone milestone = new StepMilestone.Builder()
//        .setTrigger(
...
//    double stepDurationTotal = routeProgress.currentLegProgress().getCurrentStep().getDuration();
//
//    for (int i = 10; i > 0; i--) {
//      Milestone milestone = new StepMilestone.Builder()
//        .setTrigger(
...
//    int stepIndex = routeProgress.currentLegProgress().getStepIndex();
//
//    for (int i = 10; i > 0; i--) {
//      Milestone milestone = new StepMilestone.Builder()
//        .setTrigger(
