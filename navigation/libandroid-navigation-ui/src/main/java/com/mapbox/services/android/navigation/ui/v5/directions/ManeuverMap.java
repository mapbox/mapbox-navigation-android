...
class ManeuverMap {
  ...
  private static final String STEP_MANEUVER_MODIFIER_UTURN = "uturn";
  private static final String STEP_MANEUVER_MODIFIER_SHARP_RIGHT = "sharp right";
  private static final String STEP_MANEUVER_MODIFIER_RIGHT = "right";
  private static final String STEP_MANEUVER_MODIFIER_SLIGHT_RIGHT = "slight right";
  private static final String STEP_MANEUVER_MODIFIER_STRAIGHT = "straight";
  private static final String STEP_MANEUVER_MODIFIER_SLIGHT_LEFT = "slight left";
  private static final String STEP_MANEUVER_MODIFIER_LEFT = "left";
  private static final String STEP_MANEUVER_MODIFIER_SHARP_LEFT = "sharp left";
