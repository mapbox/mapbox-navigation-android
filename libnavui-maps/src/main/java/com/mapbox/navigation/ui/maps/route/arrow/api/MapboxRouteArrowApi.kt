...
class MapboxRouteArrowApi {
     ...
     *
     * @return the [Expected<UpdateManeuverArrowValue, InvalidPointError>] for rendering by the view.
     */
    fun addUpcomingManeuverArrow(routeProgress: RouteProgress):
        Expected<UpdateManeuverArrowValue, InvalidPointError> {
        ...
        return when (val addArrowResult = addArrow(maneuverPoints)) {
            is Expected.Failure -> {
                addArrowResult
            }
            is Expected.Success -> {
     ...
     *
     * @return an Expected<ArrowAddedValue, InvalidPointError>
     */
    fun addArrow(arrow: ManeuverArrow): Expected<ArrowAddedValue, InvalidPointError> {
