...
class MapboxRouteLineApi(
     ...
     *
     * If the vanishing route line feature was not enabled in [MapboxRouteLineOptions],
     * this method does not need to be called.
     *
     * Likewise if the style inactive route legs independently feature was not enabled in
     * [MapboxRouteLineOptions] this method does not need to be called.
     *
