...
```
implementation 'com.mapbox.mapboxsdk:mapbox-android-navigation:0.33.0'
```

And for `libandroid-navigation-ui`:

```
implementation 'com.mapbox.mapboxsdk:mapbox-android-navigation-ui:0.33.0'
```
...
dependencies {
    implementation 'com.mapbox.mapboxsdk:mapbox-android-navigation:0.34.0-SNAPSHOT'
}
```
