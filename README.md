...
```
implementation 'com.mapbox.mapboxsdk:mapbox-android-navigation:0.25.0'
```

And for `libandroid-navigation-ui`:

```
implementation 'com.mapbox.mapboxsdk:mapbox-android-navigation-ui:0.25.0'
```
...
dependencies {
    implementation 'com.mapbox.mapboxsdk:mapbox-android-navigation:0.26.0-SNAPSHOT'
}
```
