...
internal class MapboxInvalidModuleException(type: MapboxNavigationModuleType) : RuntimeException(
    ...
    - You've provided a `ModuleProvider` instance to ${String.format(MODULE_CONFIGURATION_CLASS_NAME_FORMAT, type.name)}#set${MODULE_CONFIGURATION_PROVIDER_VARIABLE_NAME.capitalize()} before initializing the library,
