 ...
 *
 * @see RoadObject
 * @see RoadObjectType.RESTRICTED_AREA_EXIT
 */
class RestrictedAreaExit private constructor(
    ...
    override fun toString(): String {
        return "RestrictedAreaExitAlert() ${super.toString()}"
    }

    /**
     * Use to create a new instance.
     *
     * @see RestrictedAreaExit
     */
    class Builder(
