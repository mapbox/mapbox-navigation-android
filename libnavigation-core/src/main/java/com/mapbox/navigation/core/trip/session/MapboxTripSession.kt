 ...
 * For more information see [MapboxNativeNavigatorImpl.generateTripStatusFrom]. Unit is milliseconds
            ...
            object : NavigatorObserver() {
                override fun onStatus(origin: NavigationStatusOrigin, status: NavigationStatus) {
                    mainJobController.scope.launch {
                        ...
                        val keyPoints = tripStatus.navigationStatus.key_points.toLocations()
