 ...
 */
object RoutesPreviewUpdateReasons {
    /**
     * Routes for preview were set by user.
     * [RoutesPreviewUpdate.routesPreview] always has value for this reason.
     * @see [RoutesPreviewObserver]
     */
    const val PREVIEW_NEW = "PREVIEW_SET"

    /***
     * Routes preview has initial state or were cleanup by user.
...
@StringDef(
    RoutesPreviewUpdateReasons.PREVIEW_NEW,
