...
class ReplayHistoryMapper private constructor(
    ...
    class Builder {
        ...
        private companion object {
            val DefaultLocationMapper: ReplayHistoryEventMapper<HistoryEventUpdateLocation> =
                ReplayHistoryEventMapper {
                    ReplayRouteMapper.mapToUpdateLocation(it.eventTimestamp, it.location)
                }

            val DefaultSetRouteMapper: ReplayHistoryEventMapper<HistoryEventSetRoute> =
                ReplayHistoryEventMapper {
                    ReplaySetRoute(
            ...
            val DefaultStatusMapper: ReplayHistoryEventMapper<HistoryEventGetStatus> =
                ReplayHistoryEventMapper {
