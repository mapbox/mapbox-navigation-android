...
class MapboxNavigationAccountsTest {
    ...
    @Test
    fun obtainSkuToken_when_resourceUrl_notNullOrEmpty_querySize_zero_sessionActiveGuidance() {
        every {
    ...
    @Test
    fun obtainSkuToken_when_resourceUrl_notNullOrEmpty_querySize_not_zero_sessionActiveGuidance() {
        every {
            BillingServiceWrapper.getSessionStatus(SKUIdentifier.NAV2_SES_TRIP)
        } returns BillingSessionStatus.SESSION_ACTIVE
        every {
