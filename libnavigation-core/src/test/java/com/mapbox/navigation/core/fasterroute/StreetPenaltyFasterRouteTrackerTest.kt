...
class StreetPenaltyFasterRouteTrackerTest {
    ...
    fun `no faster route is available from Munich to Nuremberg moving by the slowest road`() =
        runBlocking<Unit> {
            val fasterRoutes = createStreetPenaltyFasterRoutesTrackerCore()
    ...
    fun `faster route is available driving in Munich after picking the slowest road`() =
        runBlocking<Unit> {
            val fasterRoutesTracker = createStreetPenaltyFasterRoutesTrackerCore()
...
internal fun createStreetPenaltyFasterRoutesTrackerCore() = StreetPenaltyFasterRouteTrackerCore()
