...
class MapboxTripSessionTest {
    ...
    fun setUp() {
        ...
        coEvery { MapboxNativeNavigatorImpl.generateTripStatusFrom(any()) } returns tripStatus
        ...
        every {
            navigator.setNavigatorObserver(capture(navigatorObserverImplSlot))
        } answers {}
    }
    ...
    fun stopTripSessionShouldStopRouteProgress() = coroutineRule.runBlockingTest {
        ...
        coVerify(exactly = 1) { navigator.setNavigatorObserver(null) }
    }
