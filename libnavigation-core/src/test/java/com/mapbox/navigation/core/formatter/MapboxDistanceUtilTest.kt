...
class MapboxDistanceUtilTest {
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance large value imperial with undefined rounding increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            19312.1,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL,
            ctx
        )
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance large value UK with undefined rounding increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            19312.1,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL,
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance large value metric with undefined rounding increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            19312.1,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC,
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance small value imperial with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            118.0, // 387 feet
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL,
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance medium fractional value metric with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            1100.5,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC,
    ...
    @Config(qualifiers = "en-rGB")
    @Test
    fun `formatDistance medium value UK with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            15000.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL,
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance invalid value imperial with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            -19312.1,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL,
    ...
    @Config(qualifiers = "en-rGB")
    @Test
    fun `formatDistance invalid large value UK with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            -19312.1,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL,
    ...
    @Config(qualifiers = "en")
    @Test
    fun `formatDistance invalid large value metric with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            -19312.1,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC,
    ...
    @Test
    fun `formatDistance imperial with undefined increment return small distance only`() {
        val result = MapboxDistanceUtil.formatDistance(
            23.1, // 76 feet
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    fun `formatDistance imperial return small distance only for negative with undefined inc`() {
        val result = MapboxDistanceUtil.formatDistance(
            -10.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    @Config(qualifiers = "en-rGB")
    fun `formatDistance UK return small distance only for negative with undefined inc`() {
        val result = MapboxDistanceUtil.formatDistance(
            -10.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    fun `formatDistance imperial return medium distance only with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            13000.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Config(qualifiers = "en-rGB")
    @Test
    fun `formatDistance UK return medium distance only with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            10456.3,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    fun `formatDistance imperial return large distance only with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            10800.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Config(qualifiers = "en-rGB")
    @Test
    fun `formatDistance UK return large distance only with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            10800.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    fun `formatDistance invalid metric with undefined increment returns fifty`() {
        val result = MapboxDistanceUtil.formatDistance(
            -15000.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC
    ...
    @Config(qualifiers = "en-rGB")
    @Test
    fun `formatDistance UK invalid with undefined increment returns fifty`() {
        val result = MapboxDistanceUtil.formatDistance(
            -15000.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    fun `formatDistance invalid imperial with undefined increment returns fifty`() {
        val result = MapboxDistanceUtil.formatDistance(
            -1500.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.IMPERIAL
    ...
    @Test
    fun `formatDistance metric return small distance only for negative with undefined inc`() {
        val result = MapboxDistanceUtil.formatDistance(
            -10.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC
    ...
    @Test
    fun `formatDistance metric return medium distance only with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            2367.354,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC
    ...
    @Test
    fun `formatDistance metric return large distance only with undefined increment`() {
        val result = MapboxDistanceUtil.formatDistance(
            10800.0,
            Rounding.INCREMENT_UNDEFINED,
            UnitType.METRIC
