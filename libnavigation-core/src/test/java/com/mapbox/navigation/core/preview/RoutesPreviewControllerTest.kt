...
class RoutesPreviewControllerTest {
    ...
    fun `default state`() {
        ...
        routesPreviewController.registerPreviewRoutesObserver {
            previewUpdate = it
        }
    ...
    fun `set previewed routes`() {
        ...
        assertEquals(RoutesPreviewUpdateReasons.PREVIEW_NEW, previewUpdate!!.reason)
    ...
    fun `clean-up routes preview`() {
        ...
        assertEquals(RoutesPreviewUpdateReasons.PREVIEW_CLEAN_UP, result.reason)
