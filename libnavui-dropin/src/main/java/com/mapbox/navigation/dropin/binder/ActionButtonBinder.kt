...
import com.mapbox.navigation.ui.voice.internal.ui.AudioComponentApi
    ...
    private fun audioGuidanceButtonComponent(
        ...
        return AudioGuidanceButtonComponent(binding.soundButton, style).apply {
            apiProvider = Provider {
                DropInAudioComponentApi(context.viewModel.viewModelScope, store)
            }
        }
    }
}
...
@ExperimentalPreviewMapboxNavigationAPI
internal class DropInAudioComponentApi(
