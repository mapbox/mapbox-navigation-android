...
import com.mapbox.navigation.ui.maps.internal.ui.RouteLineComponentApi
    ...
    private fun routeLineComponent(lineOptions: MapboxRouteLineOptions) =
        RouteLineComponent(mapView, lineOptions).apply {
            apiProvider = Provider {
                DropInRouteLineComponentApi(store)
            }
        }
...
@ExperimentalPreviewMapboxNavigationAPI
internal class DropInRouteLineComponentApi(private val store: Store) : RouteLineComponentApi {
