package com.mapbox.navigation.mapgpt.core.textplayer.options
...
class PlayerOptions private constructor(
    ...
    override fun toString(): String {
        return "PlayerOptions(focusGain=$focusGain, " +
            "streamType=$streamType, " +
            "ttsStreamType=$ttsStreamType, " +
            "usage=$usage, " +
            "contentType=$contentType, " +
    ...
    class Builder {
        ...
        /**
         * Build the [PlayerOptions]
         */
        fun build(): PlayerOptions {
