 ...
 * services. Use the [SharedPerformance.setTraceFactory] to construct your version of [DashTrace].
 */
interface DashTrace {
    /**
     ...
     */
    fun counter(key: TraceKey, block: (Long) -> Long): DashTrace

    /**
     * Add an attribute to your trace.
     */
    fun attribute(key: TraceKey, block: (Traceable?) -> TraceValue?): DashTrace

    /**
     * Add a custom attribute to your trace.
     */
    fun attributeCustom(key: TraceKey, block: (Traceable?) -> Traceable?): DashTrace
...
/**
 * No-op implementation of [DashTrace].
 */
object NoDashTrace : DashTrace {
