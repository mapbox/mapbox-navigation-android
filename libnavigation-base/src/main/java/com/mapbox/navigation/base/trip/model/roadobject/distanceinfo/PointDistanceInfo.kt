...
/**
 * PointDistanceInfo contains information about distance to the road object represented as point.
 *
 */
class PointDistanceInfo internal constructor(
    roadObjectId: String,
    @RoadObjectType.Type roadObjectType: Int,
    distance: Double,
) : RoadObjectDistanceInfo(roadObjectId, roadObjectType, RoadObjectDistanceInfoType.POINT) {
