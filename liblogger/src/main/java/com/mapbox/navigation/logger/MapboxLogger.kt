...
object MapboxLogger : Logger {
    ...
    fun v(msg: String, tag: Tag) {
        v(msg, tag, null)
    }

    override fun v(msg: String, tag: Tag?, tr: Throwable?) {
        log(VERBOSE, tag?.tag, msg, tr) { Timber.v(tr, msg) }
    }
    ...
    fun d(msg: String, tag: Tag) {
        d(msg, tag, null)
    }

    override fun d(msg: String, tag: Tag?, tr: Throwable?) {
        log(DEBUG, tag?.tag, msg, tr) { Timber.d(tr, msg) }
    }
    ...
    fun i(msg: String, tag: Tag) {
        i(msg, tag, null)
    }

    override fun i(msg: String, tag: Tag?, tr: Throwable?) {
        log(INFO, tag?.tag, msg, tr) { Timber.i(tr, msg) }
    }
    ...
    fun w(msg: String, tag: Tag) {
        w(msg, tag, null)
    }

    override fun w(msg: String, tag: Tag?, tr: Throwable?) {
        log(WARN, tag?.tag, msg, tr) { Timber.w(tr, msg) }
    }
    ...
    fun e(msg: String, tag: Tag) {
        e(msg, tag, null)
    }

    override fun e(msg: String, tag: Tag?, tr: Throwable?) {
        log(ERROR, tag?.tag, msg, tr) { Timber.e(tr, msg) }
    }
