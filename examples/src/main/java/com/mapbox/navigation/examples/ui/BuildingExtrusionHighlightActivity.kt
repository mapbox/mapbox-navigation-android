...
class BuildingExtrusionHighlightActivity : AppCompatActivity(), OnNavigationReadyCallback,
    ...
    override fun onRouteProgressChanged(routeProgress: RouteProgress) {
        /**
         * Show the building extrusion when the device is 250 meters away from the
         * end of the [DirectionsRoute] and if the extrusion hasn't already been shown.
         */
        if (routeProgress.distanceRemaining < 250f && !higlightedExtrusionAlreadyShown) {
            ...
            mapboxMap.getStyle {
                 ...
                 * as the device remains less than 250 meters away from the end of the
                 * [DirectionsRoute].
                 */
