 ...
 *
 * In this example the vanishing route line option of [MapboxRouteLineOptions] is disabled
 * (the default). It's important to take note of the code in the [RouteProgressObserver] below.
 *
 * If you wish to use the feature demonstrated here with the vanishing route line enabled then
 * follow the documentation for using the vanishing route line feature and also enable the
 * deEmphasizeInactiveRouteLegs in the [MapboxRouteLineOptions] and nothing more will need to
 * be done. The vanishing route line implementation will take care of hiding or de-emphasizing
 * the inactive route legs.
 */
class MultiLegRouteExampleActivity : AppCompatActivity() {
    ...
    private val options: MapboxRouteLineOptions by lazy {
        MapboxRouteLineOptions.Builder(this)
            ...
            .withVanishingRouteLineEnabled(false) // Important for this example
            .build()
    }
