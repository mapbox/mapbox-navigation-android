...
class MapboxRouteLineAndArrowActivity : AppCompatActivity(), OnMapLongClickListener {
    ...
    //Point.fromLngLat(-122.66743711143083, 45.637156363108105), Point.fromLngLat(-122.67117999435773, 45.63660582500783), Point.fromLngLat(-122.67147361785446, 45.63566210717601), Point.fromLngLat(-122.66713095440821, 45.63561846681017), Point.fromLngLat(-122.66742461493801, 45.63709082769017), Point.fromLngLat(-122.66928668721683, 45.63676751447727)
