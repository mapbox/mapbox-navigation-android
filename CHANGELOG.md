...
- Remove `MapboxNavigation#installComponents` in favor of `MapboxNavigationApp#installComponents`. [#6120](https://github.com/mapbox/mapbox-navigation-android/pull/6120)
