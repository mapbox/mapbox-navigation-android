...
- Added Experimental API `NavigationRoute#hasUnexpectedClosures` to check if a route has unexpected closures and it's required to be re-routed. [#6295](https://github.com/mapbox/mapbox-navigation-android/pull/6295)
