...
## Mapbox Navigation SDK 2.2.0-beta.1 - December 10, 2021
...
- Refactored `RouteProgress.voiceInstructions` property always keeps the very last value and doesn't become `null`. [#5126](https://github.com/mapbox/mapbox-navigation-android/pull/5126)
