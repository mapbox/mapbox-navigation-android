## Navigation SDK Core Framework 3.32.0-rc.1 - 21 September, 2026
#### Features
...
- Mapbox Maps SDK `v11.32.0-rc.1` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.32.0-rc.1))
- Mapbox Navigation Native `v324.32.0-rc.1`
...
## Navigation SDK Core Framework 3.30.2 - 18 September, 2026
#### Features
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v11.30.2` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.30.2))
- Mapbox Navigation Native `v324.30.2`
- Mapbox Core Common `v24.30.2`
- Mapbox Java `v7.10.1` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.10.1))
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v11.30.0` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.30.0))
- Mapbox Navigation Native `v324.30.0`
- Mapbox Core Common `v24.30.0`
- Mapbox Java `v7.10.1` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.10.1))
...
## Navigation SDK Core Framework 3.29.3 - 10 September, 2026
#### Features
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v11.29.3` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.29.3))
- Mapbox Navigation Native `v324.29.3`
- Mapbox Core Common `v24.29.3`
- Mapbox Java `v7.10.1` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.10.1))
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v11.29.1` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.29.1))
- Mapbox Navigation Native `v324.29.1`
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v11.28.3` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.28.3))
- Mapbox Navigation Native `v324.28.3`
- Mapbox Core Common `v24.28.3`
- Mapbox Java `v7.10.0` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.10.0))
...
## Navigation SDK Core Framework 3.28.0-rc.1 - 27 July, 2026
#### Features
...
## Navigation SDK Core Framework 3.27.0 - 24 July, 2026
#### Features
...
## Navigation SDK Core Framework 3.27.0-rc.1 - 13 July, 2026
#### Features
...
## Navigation SDK Core Framework 3.26.0 - 09 July, 2026
#### Features
...
## Navigation SDK Core Framework 3.25.0-rc.2 - 04 June, 2026
#### Features
...
## Navigation SDK Core Framework 3.24.2 - 20 May, 2026
#### Features
...
## Navigation SDK Core Framework 3.24.1 - 19 May, 2026
#### Features
...
## Navigation SDK Core Framework 3.24.0 - 18 May, 2026
#### Features
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v11.24.0` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.24.0))
- Mapbox Navigation Native `v324.24.0`
- Mapbox Core Common `v24.24.0`
- Mapbox Java `v7.10.0` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.10.0))
