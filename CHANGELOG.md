...
- Mapbox Core Common `v23.12.0`
- Mapbox Java `v7.1.0` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.1.0))


## Mapbox Navigation SDK 2.22.1 - 06 May, 2026
### Changelog
[Changes between v2.22.0 and v2.22.1](https://github.com/mapbox/mapbox-navigation-android/compare/v2.22.0...v2.22.1)

#### Features
- Added Feedback Agent.  [#7945](https://github.com/mapbox/navigation/pull/7945)
...
### Mapbox dependencies
This release depends on, and has been tested with, the following Mapbox dependencies:
- Mapbox Maps SDK `v10.18.1` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v10.18.1))
- Mapbox Navigation Native `v206.0.0`
- Mapbox Core Common `v23.10.1`
...
### Changelog
[Changes between v2.19.1 and v2.20.0-beta.1](https://github.com/mapbox/mapbox-navigation-android/compare/v2.19.1...v2.20.0-beta.1)
...
### Changelog
[Changes between v2.17.10 and v2.17.11](https://github.com/mapbox/mapbox-navigation-android/compare/v2.17.10...v2.17.11)

#### Features


#### Bug fixes and improvements
- Fix of ADAS cache eviction mechanism bug led to missing ADAS data. [#7737](https://github.com/mapbox/mapbox-navigation-android/pull/7737)
