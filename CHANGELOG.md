## Navigation SDK Core Framework 3.27.3 - 21 August, 2026
#### Features
...
- Mapbox Maps SDK `v11.27.3` ([release notes](https://github.com/mapbox/mapbox-maps-android/releases/tag/v11.27.3))
- Mapbox Navigation Native `v324.27.3`
- Mapbox Core Common `v24.27.3`
- Mapbox Java `v7.10.0` ([release notes](https://github.com/mapbox/mapbox-java/releases/tag/v7.10.0))

## Navigation SDK Core Framework 3.27.2 - 13 August, 2026
#### Features
...
## Navigation SDK Core Framework 3.27.1 - 04 August, 2026
#### Features
