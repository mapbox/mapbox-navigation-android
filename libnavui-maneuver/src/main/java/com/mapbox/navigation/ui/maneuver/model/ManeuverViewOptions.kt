...
class ManeuverViewOptions private constructor(
    ...
    class Builder {
         ...
         * @return Builder
         */
        fun maneuverBackgroundColor(@ColorRes maneuverBackgroundColor: Int) = apply {
         ...
         * @return Builder
         */
        fun subManeuverBackgroundColor(@ColorRes subManeuverBackgroundColor: Int) = apply {
         ...
         * @return Builder
         */
        fun turnIconManeuver(@StyleRes turnIconManeuver: Int) = apply {
         ...
         * @return Builder
         */
        fun stepDistanceTextAppearance(@StyleRes stepDistanceTextAppearance: Int) = apply {
         ...
         * @return Builder
         */
        fun laneGuidanceTurnIconManeuver(@StyleRes laneGuidanceTurnIconManeuver: Int) = apply {
