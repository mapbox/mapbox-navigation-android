...
public class LanesStyleKit {
    ...
    private static class CacheForLane_straight_right {
    ...
    public static void drawLane_straight_right(Canvas canvas, int primaryColor) {
        LanesStyleKit.drawLane_straight_right(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor);
    }
    
    public static void drawLane_straight_right(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor) {
        // General Declarations
        Paint paint = CacheForLane_straight_right.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_straight_right.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_straight_right.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        
        // Rectangle
        RectF rectangleRect = CacheForLane_straight_right.rectangleRect;
        rectangleRect.set(9.05f, 11.6f, 13.05f, 26.6f);
        Path rectanglePath = CacheForLane_straight_right.rectanglePath;
        rectanglePath.reset();
        ...
        // Bezier
        RectF bezierRect = CacheForLane_straight_right.bezierRect;
        bezierRect.set(5f, 2f, 17.02f, 11.99f);
        Path bezierPath = CacheForLane_straight_right.bezierPath;
        bezierPath.reset();
        ...
        // Bezier 2
        RectF bezier2Rect = CacheForLane_straight_right.bezier2Rect;
        bezier2Rect.set(17.99f, 10.58f, 26.97f, 22.6f);
        Path bezier2Path = CacheForLane_straight_right.bezier2Path;
        bezier2Path.reset();
        ...
        // Bezier 3
        RectF bezier3Rect = CacheForLane_straight_right.bezier3Rect;
        bezier3Rect.set(11.03f, 16.61f, 20.03f, 27f);
        Path bezier3Path = CacheForLane_straight_right.bezier3Path;
        bezier3Path.reset();
    ...
    private static class CacheForLane_straight_only {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 30f, 30f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezier2Rect = new RectF();
    ...
    public static void drawLane_straight_only(Canvas canvas, int primaryColor, int secondaryColor) {
        LanesStyleKit.drawLane_straight_only(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor, secondaryColor);
    }
    
    public static void drawLane_straight_only(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, int secondaryColor) {
        // General Declarations
        Paint paint = CacheForLane_straight_only.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_straight_only.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_straight_only.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        
        // Bezier 2
        RectF bezier2Rect = CacheForLane_straight_only.bezier2Rect;
        bezier2Rect.set(17.99f, 10.58f, 26.97f, 22.6f);
        Path bezier2Path = CacheForLane_straight_only.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(18.05f, 14.59f);
        bezier2Path.lineTo(19.31f, 14.59f);
        bezier2Path.lineTo(19.31f, 14.59f);
        ...
        // Bezier 3
        RectF bezier3Rect = CacheForLane_straight_only.bezier3Rect;
        bezier3Rect.set(11.03f, 16.61f, 20.03f, 27f);
        Path bezier3Path = CacheForLane_straight_only.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(11.03f, 27f);
        bezier3Path.lineTo(11.03f, 22.87f);
        bezier3Path.cubicTo(11.03f, 21.23f, 11.73f, 19.65f, 13f, 18.61f);
        ...
        // Rectangle
        RectF rectangleRect = CacheForLane_straight_only.rectangleRect;
        rectangleRect.set(9.05f, 11.6f, 13.05f, 26.6f);
        Path rectanglePath = CacheForLane_straight_only.rectanglePath;
        rectanglePath.reset();
        rectanglePath.moveTo(rectangleRect.left, rectangleRect.top);
        rectanglePath.lineTo(rectangleRect.right, rectangleRect.top);
        rectanglePath.lineTo(rectangleRect.right, rectangleRect.bottom);
        ...
        // Bezier
        RectF bezierRect = CacheForLane_straight_only.bezierRect;
        bezierRect.set(5f, 2f, 17.02f, 11.99f);
        Path bezierPath = CacheForLane_straight_only.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(11.02f, 2f);
        bezierPath.cubicTo(11.06f, 2.06f, 16.74f, 9.97f, 16.86f, 10.13f);
        bezierPath.cubicTo(16.96f, 10.23f, 17.02f, 10.37f, 17.02f, 10.52f);
    ...
    private static class CacheForLane_right_h {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 30f, 30f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawLane_right_h(Canvas canvas, int primaryColor) {
        LanesStyleKit.drawLane_right_h(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor);
    }
    
    public static void drawLane_right_h(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor) {
        // General Declarations
        Paint paint = CacheForLane_right_h.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_right_h.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_right_h.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        
        // Bezier
        RectF bezierRect = CacheForLane_right_h.bezierRect;
        bezierRect.set(14.87f, 4f, 23.85f, 16.02f);
        Path bezierPath = CacheForLane_right_h.bezierPath;
        bezierPath.reset();
        ...
        // Bezier 2
        RectF bezier2Rect = CacheForLane_right_h.bezier2Rect;
        bezier2Rect.set(9f, 10.03f, 20.03f, 25f);
        Path bezier2Path = CacheForLane_right_h.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(9f, 25f);
    ...
    private static class CacheForLane_right_only {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 30f, 30f);
        private static RectF resizedFrame = new RectF();
        private static RectF rectangleRect = new RectF();
    ...
    public static void drawLane_right_only(Canvas canvas, int primaryColor, int secondaryColor) {
        LanesStyleKit.drawLane_right_only(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor, secondaryColor);
    }
    
    public static void drawLane_right_only(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, int secondaryColor) {
        // General Declarations
        Paint paint = CacheForLane_right_only.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_right_only.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_right_only.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        
        // Rectangle
        RectF rectangleRect = CacheForLane_right_only.rectangleRect;
        rectangleRect.set(9.05f, 11.6f, 13.05f, 26.6f);
        Path rectanglePath = CacheForLane_right_only.rectanglePath;
        rectanglePath.reset();
        rectanglePath.moveTo(rectangleRect.left, rectangleRect.top);
        rectanglePath.lineTo(rectangleRect.right, rectangleRect.top);
        rectanglePath.lineTo(rectangleRect.right, rectangleRect.bottom);
        ...
        // Bezier
        RectF bezierRect = CacheForLane_right_only.bezierRect;
        bezierRect.set(5f, 2f, 17.02f, 11.99f);
        Path bezierPath = CacheForLane_right_only.bezierPath;
        bezierPath.reset();
        bezierPath.moveTo(11.02f, 2f);
        bezierPath.cubicTo(11.06f, 2.06f, 16.74f, 9.97f, 16.86f, 10.13f);
        bezierPath.cubicTo(16.96f, 10.23f, 17.02f, 10.37f, 17.02f, 10.52f);
        ...
        // Bezier 2
        RectF bezier2Rect = CacheForLane_right_only.bezier2Rect;
        bezier2Rect.set(17.99f, 10.58f, 26.97f, 22.6f);
        Path bezier2Path = CacheForLane_right_only.bezier2Path;
        bezier2Path.reset();
        bezier2Path.moveTo(18.05f, 14.59f);
        bezier2Path.lineTo(19.31f, 14.59f);
        bezier2Path.lineTo(19.31f, 14.59f);
        ...
        // Bezier 3
        RectF bezier3Rect = CacheForLane_right_only.bezier3Rect;
        bezier3Rect.set(11.03f, 16.61f, 20.03f, 27f);
        Path bezier3Path = CacheForLane_right_only.bezier3Path;
        bezier3Path.reset();
        bezier3Path.moveTo(11.03f, 27f);
        bezier3Path.lineTo(11.03f, 22.87f);
        bezier3Path.cubicTo(11.03f, 21.23f, 11.73f, 19.65f, 13f, 18.61f);
    ...
    private static class CacheForLane_straight {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 30f, 30f);
        private static RectF resizedFrame = new RectF();
        private static RectF rectangleRect = new RectF();
    ...
    public static void drawLane_straight(Canvas canvas, int primaryColor) {
        LanesStyleKit.drawLane_straight(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor);
    }
    
    public static void drawLane_straight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor) {
        // General Declarations
        Paint paint = CacheForLane_straight.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_straight.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_straight.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        
        // Rectangle
        RectF rectangleRect = CacheForLane_straight.rectangleRect;
        rectangleRect.set(13f, 11f, 17f, 27f);
        Path rectanglePath = CacheForLane_straight.rectanglePath;
        rectanglePath.reset();
        ...
        // Bezier
        RectF bezierRect = CacheForLane_straight.bezierRect;
        bezierRect.set(9f, 3f, 21.02f, 12.99f);
        Path bezierPath = CacheForLane_straight.bezierPath;
        bezierPath.reset();
    ...
    private static class CacheForLane_uturn {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 30f, 30f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezierRect = new RectF();
    ...
    public static void drawLane_uturn(Canvas canvas, int primaryColor) {
        LanesStyleKit.drawLane_uturn(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor);
    }
    
    public static void drawLane_uturn(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor) {
        // General Declarations
        Paint paint = CacheForLane_uturn.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_uturn.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_uturn.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        
        // Bezier
        RectF bezierRect = CacheForLane_uturn.bezierRect;
        bezierRect.set(9f, 5f, 19f, 27f);
        Path bezierPath = CacheForLane_uturn.bezierPath;
        bezierPath.reset();
        ...
        // Bezier 2
        RectF bezier2Rect = CacheForLane_uturn.bezier2Rect;
        bezier2Rect.set(13.01f, 17.99f, 25f, 26.97f);
        Path bezier2Path = CacheForLane_uturn.bezier2Path;
        bezier2Path.reset();
    ...
    private static class CacheForLane_slight_right {
        private static Paint paint = new Paint();
        private static RectF originalFrame = new RectF(0f, 0f, 30f, 30f);
        private static RectF resizedFrame = new RectF();
        private static RectF bezier3Rect = new RectF();
    ...
    public static void drawLane_slight_right(Canvas canvas, int primaryColor, float scale) {
        LanesStyleKit.drawLane_slight_right(canvas, new RectF(0f, 0f, 30f, 30f), ResizingBehavior.AspectFit, primaryColor, scale);
    }
    
    public static void drawLane_slight_right(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, float scale) {
        // General Declarations
        Stack<Matrix> currentTransformation = new Stack<Matrix>();
        currentTransformation.push(new Matrix());
        Paint paint = CacheForLane_slight_right.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForLane_slight_right.resizedFrame;
        LanesStyleKit.resizingBehaviorApply(resizing, CacheForLane_slight_right.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 30f, resizedFrame.height() / 30f);
        ...
        // Group 3
        {
            ...
            // Bezier 3
            RectF bezier3Rect = CacheForLane_slight_right.bezier3Rect;
            bezier3Rect.set(-12.38f, -0.49f, -5.33f, 14.76f);
            Path bezier3Path = CacheForLane_slight_right.bezier3Path;
            bezier3Path.reset();
            bezier3Path.moveTo(-5.33f, -0.49f);
            bezier3Path.lineTo(-11.03f, 4.79f);
            bezier3Path.cubicTo(-11.9f, 6.11f, -12.38f, 7.72f, -12.38f, 9.37f);
            bezier3Path.lineTo(-12.38f, 14.76f);
            ...
            // Bezier 4
            RectF bezier4Rect = CacheForLane_slight_right.bezier4Rect;
            bezier4Rect.set(-8.78f, -6.29f, 1.32f, 3.59f);
            Path bezier4Path = CacheForLane_slight_right.bezier4Path;
            bezier4Path.reset();
            bezier4Path.moveTo(-8.39f, -5.75f);
            bezier4Path.lineTo(1.32f, -6.29f);
            bezier4Path.lineTo(-0.62f, 3.25f);
            bezier4Path.cubicTo(-0.63f, 3.35f, -0.67f, 3.44f, -0.75f, 3.5f);
            bezier4Path.cubicTo(-0.91f, 3.64f, -1.14f, 3.62f, -1.28f, 3.46f);
            bezier4Path.cubicTo(-1.3f, 3.44f, -1.33f, 3.39f, -1.33f, 3.39f);
            bezier4Path.lineTo(-3.12f, 0.2f);
            bezier4Path.cubicTo(-3.13f, 0.16f, -3.15f, 0.13f, -3.18f, 0.1f);
            bezier4Path.cubicTo(-3.31f, -0.05f, -3.69f, 0.05f, -3.84f, 0.18f);
            bezier4Path.cubicTo(-4.05f, 0.36f, -5.41f, 1.55f, -5.41f, 1.55f);
            bezier4Path.lineTo(-6.4f, 0.4f);
            bezier4Path.lineTo(-7.39f, -0.75f);
            bezier4Path.cubicTo(-7.39f, -0.75f, -6.02f, -1.93f, -5.82f, -2.11f);
            bezier4Path.cubicTo(-5.67f, -2.24f, -5.58f, -2.54f, -5.72f, -2.7f);
            bezier4Path.cubicTo(-5.74f, -2.73f, -5.73f, -2.78f, -5.76f, -2.8f);
            bezier4Path.lineTo(-8.64f, -5.05f);
            bezier4Path.cubicTo(-8.64f, -5.05f, -8.68f, -5.1f, -8.69f, -5.12f);
            bezier4Path.cubicTo(-8.83f, -5.28f, -8.81f, -5.52f, -8.65f, -5.65f);
            bezier4Path.cubicTo(-8.58f, -5.72f, -8.48f, -5.75f, -8.39f, -5.75f);
            bezier4Path.close();
            ...
            // Clip
            RectF clipRect = CacheForLane_slight_right.clipRect;
            clipRect.set(-13.78f, -7f, 1.62f, 13.24f);
