...
public class ManeuversStyleKit {
  ...
  public static void drawTest(Canvas canvas, int primaryColor) {
    ManeuversStyleKit.drawTest(canvas, new RectF(0f, 0f, 150f, 150f), ResizingBehavior.AspectFit, primaryColor);
  }

  // Canvas Drawings
  // Maneuvers

  public static void drawTest(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    Paint paint = CacheForTest.paint;

    // Resize to Target Frame
    canvas.save();
    RectF resizedFrame = CacheForTest.resizedFrame;
    ManeuversStyleKit.resizingBehaviorApply(resizing, CacheForTest.originalFrame, targetFrame, resizedFrame);
    ...
    currentTransformation.peek().postTranslate(25f, 25f);
    RectF bezier2Rect = CacheForTest.bezier2Rect;
    bezier2Rect.set(-10f, -10.5f, 10f, 10.5f);
    Path bezier2Path = CacheForTest.bezier2Path;
    bezier2Path.reset();
  ...
  public static void drawArrow180(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrow180(canvas, new RectF(0f, 0f, 50f, 50f), ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrow180(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    // Frame
    RectF frame = CacheForArrow180.frame;
  ...
  public static void drawArrow45(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrow45(canvas, new RectF(0f, 0f, 50f, 50f), ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrow45(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    // Frame
    RectF frame = CacheForArrow45.frame;
    frame.set(0f, 0f, size.x, size.y);
  ...
  public static void drawArrow30(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrow30(canvas, new RectF(0f, 0f, 50f, 50f), ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrow30(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    // Frame
    RectF frame = CacheForArrow30.frame;
    frame.set(0f, 0f, size.x, size.y);
  ...
  public static void drawArrow0(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrow0(canvas, new RectF(0f, 0f, 50f, 50f), ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrow0(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    // Frame
    RectF frame = CacheForArrow0.frame;
    frame.set(0f, 0f, size.x, size.y);
  ...
  public static void drawArrow75(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrow75(canvas, new RectF(0f, 0f, 50f, 50f), ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrow75(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    // Frame
    RectF frame = CacheForArrow75.frame;
    frame.set(0f, 0f, size.x, size.y);
  ...
  private static class CacheForTest {
