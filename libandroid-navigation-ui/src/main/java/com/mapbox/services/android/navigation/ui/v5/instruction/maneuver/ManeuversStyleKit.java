...
public class ManeuversStyleKit {
  ...
  public static void drawArrow180Right(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrow180Right(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrow180Right(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                       int primaryColor, PointF size) {
  ...
  public static void drawArrowRight(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrowRight(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrowRight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                    int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawArrowSlightRight(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrowSlightRight(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrowSlightRight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                          int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    ManeuversStyleKit.resizingBehaviorApply(resizing, CacheForArrowslightright.originalFrame,
      targetFrame, resizedFrame);
    canvas.translate(resizedFrame.left, resizedFrame.top);
    canvas.scale(resizedFrame.width() / 50f, resizedFrame.height() / 50f);
  ...
  public static void drawArrowStraight(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrowStraight(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrowStraight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                       int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawArrowSharpRight(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrowSharpRight(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrowSharpRight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                         int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawArrive(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArrive(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArrive(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawStarting(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawStarting(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawStarting(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                  int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawDestination(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawDestination(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawDestination(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                     int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawMerge(Canvas canvas, int primaryColor, int secondaryColor, PointF size) {
    ManeuversStyleKit.drawMerge(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, secondaryColor, size);
  }

  public static void drawMerge(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                               int primaryColor, int secondaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawFork(Canvas canvas, int primaryColor, int secondaryColor, PointF size) {
    ManeuversStyleKit.drawFork(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, secondaryColor, size);
  }

  public static void drawFork(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                              int primaryColor, int secondaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawOfframp(Canvas canvas, int primaryColor, int secondaryColor, PointF size) {
    ManeuversStyleKit.drawOfframp(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, secondaryColor, size);
  }

  public static void drawOfframp(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                 int primaryColor, int secondaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawArriveright(Canvas canvas, int primaryColor, PointF size) {
    ManeuversStyleKit.drawArriveright(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, size);
  }

  public static void drawArriveright(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                     int primaryColor, PointF size) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
  ...
  public static void drawRoundabout(Canvas canvas, int primaryColor, int secondaryColor,
                                    PointF size, float roundabout_angle) {
    ManeuversStyleKit.drawRoundabout(canvas, new RectF(0f, 0f, 50f, 50f),
      ResizingBehavior.AspectFit, primaryColor, secondaryColor, size, roundabout_angle);
  }

  public static void drawRoundabout(Canvas canvas, RectF targetFrame, ResizingBehavior resizing,
                                    int primaryColor, int secondaryColor, PointF size, float roundabout_angle) {
    // General Declarations
    Stack<Matrix> currentTransformation = new Stack<Matrix>();
    currentTransformation.push(new Matrix());
    ...
    float scale = 1f;
    float roundabout_arrow_width = scale * 0.6f * (float) Math.sin((roundabout_angle - 180f)
      * (float) Math.PI / 180f) * 17f;
    float roundabout_x = size.x / 2f + roundabout_arrow_width / 2f;
    float roundabout_arrow_height = scale * Math.max(4f, (float) Math.cos((roundabout_angle - 180f)
      * (float) Math.PI / 180f) * 17f - 4f);
