...
/**
 * A segment of a route with slow traffic, defined by slow traffic ranges you can find
 * in [SlowTrafficSegmentTraits.congestionRange].
 *
...
data class SlowTrafficSegment(
    ...
    val traits: Set<SlowTrafficSegmentTraits>,
)
