...
internal class Mapbox3DBuildingView : BuildingView {
    ...
    override fun clear(style: Style) {
        ...
        val originalLayer = style.getLayerAs<FillExtrusionLayer>(
    ...
    private fun updateBuildingLayer(
        ...
        if (!style.styleLayerExists(HIGHLIGHT_BUILDING_LAYER_ID)) {
            ...
            val originalLayerProperties = style.getStyleLayerProperties(
                BUILDING_EXTRUSION_LAYER_ID,
            ).value ?: return
            ...
            val fillExtrusionLayer = FillExtrusionLayer(
                HIGHLIGHT_BUILDING_LAYER_ID,
                originalLayer.sourceId,
            )
