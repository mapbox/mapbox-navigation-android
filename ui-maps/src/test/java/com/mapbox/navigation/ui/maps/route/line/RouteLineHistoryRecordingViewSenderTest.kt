...
internal class RouteLineHistoryRecordingViewSenderTest {
    ...
    fun showCasingEvent() {
        /* ktlint-disable max-line-length */
        val expected =
            """{"value":{"styleId":"someId","action":"show_casing"},"subtype":"view","instanceId":"04feb613-8258-4304-be3f-9a7be89b6106"}"""
        /* ktlint-enable max-line-length */
        onRecorderEnabled()

        sender.sendShowCasingEvent(styleId)
    ...
    fun hideCasingEvent() {
        /* ktlint-disable max-line-length */
        val expected =
            """{"value":{"styleId":"someId","action":"hide_casing"},"subtype":"view","instanceId":"04feb613-8258-4304-be3f-9a7be89b6106"}"""
        /* ktlint-enable max-line-length */
        onRecorderEnabled()

        sender.sendHideCasingEvent(styleId)
