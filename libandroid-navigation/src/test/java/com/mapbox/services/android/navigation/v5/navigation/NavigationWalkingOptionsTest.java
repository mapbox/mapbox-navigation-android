...
public class NavigationWalkingOptionsTest {
  ...
  public void alleyBias_walkingOptionSet() {
    NavigationWalkingOptions options = NavigationWalkingOptions.Companion.builder().alleyBias(0.7).build();
  ...
  public void walkwayBias_walkingOptionSet() {
    NavigationWalkingOptions options = NavigationWalkingOptions.Companion.builder().walkwayBias(0.8).build();
  ...
  public void walkingSpeed_walkingOptionSet() {
    NavigationWalkingOptions options = NavigationWalkingOptions.Companion.builder().walkingSpeed(2.0).build();
