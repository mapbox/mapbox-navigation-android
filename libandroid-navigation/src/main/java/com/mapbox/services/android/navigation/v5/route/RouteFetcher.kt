...
class RouteFetcher {
    ...
    private var routeUtils: RouteUtils? = null
    ...
    private fun calculateRemainingApproaches(routeProgress: RouteProgress): Array<String?>? {
        ...
        val coordinatesSize = routeProgress.directionsRoute().routeOptions()!!.coordinates().size
    ...
    companion object {
        ...
        private val ORIGIN_APPROACH_THRESHOLD = 1
        private val ORIGIN_APPROACH = 0
        private val FIRST_POSITION = 0
        private val SECOND_POSITION = 1
    }
}
