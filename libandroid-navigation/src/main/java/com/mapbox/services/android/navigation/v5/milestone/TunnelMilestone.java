...
public class TunnelMilestone extends Milestone {
  ...
  TunnelMilestone(Builder builder) {
    super(builder);
  }
  ...
  private List<Pair<Double, Double>> createDistancesToTunnelIntersections(LegStep step,
    ...
    Point firstStepPoint = stepPoints.get(FIRST_STEP_INDEX);
  ...
  public static final class Builder extends Milestone.Builder {
    ...
    @Override
    public TunnelMilestone build() {
      return new TunnelMilestone(this);
    }
  }
}