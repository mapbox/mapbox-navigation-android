...
public class MetricsRouteProgress {
  ...
  public MetricsRouteProgress(@Nullable RouteProgress routeProgress) {
    if (routeProgress != null) {
      ...
      this.distanceRemaining = (int) routeProgress.distanceRemaining().intValue();
      this.durationRemaining = (int) routeProgress.durationRemaining().intValue();
      this.distanceTraveled = (int) routeProgress.distanceTraveled().intValue();
