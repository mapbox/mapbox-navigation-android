...
import com.mapbox.services.android.navigation.v5.navigation.metrics.FeedbackData;
import com.mapbox.services.android.navigation.v5.navigation.metrics.FeedbackEventData;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationCancelData;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationEventFactory;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationLocationData;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationMetadata;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationNewData;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationRerouteData;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationState;
import com.mapbox.services.android.navigation.v5.navigation.metrics.NavigationStepMetadata;
...
final class NavigationMetricsWrapper {
  ...
  static void arriveEvent(SessionState sessionState, RouteProgress routeProgress, Location location, Context context) {
    ...
    NavigationState state = NavigationState.create(metadata, context);
