...
public final class RouteRefresh {
   ...
   */
  @Deprecated
  public RouteRefresh(String accessToken, RefreshCallback refreshCallback, Context context) {
   ...
   *
   * @param accessToken mapbox access token
   * @param context required in order to instantiate interceptor
   *
   */
  public RouteRefresh(String accessToken, Context context) {
    this.accessToken = accessToken;
    this.context = context;
  }
