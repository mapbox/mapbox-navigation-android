 ...
 * new route will be fetched by {@link NavigationRouteEngine}.
 * <p>
 * {@link FasterRoute#isFasterRoute(DirectionsResponse, RouteProgress)} determines if the new route
 * retrieved by {@link NavigationRouteEngine} is actually faster than the current route.
 *
 * @since 0.9.0
 */
public abstract class FasterRoute {
   ...
   * be retrieved by {@link NavigationRouteEngine}.
   * <p>
   ...
   *
   * @param response      provided by {@link NavigationRouteEngine}
   * @param routeProgress current route progress
