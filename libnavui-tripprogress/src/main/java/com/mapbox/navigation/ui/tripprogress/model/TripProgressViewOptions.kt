...
class TripProgressViewOptions private constructor(
    ...
    class Builder {
         ...
         * @return Builder
         */
        fun distanceRemainingIcon(@DrawableRes distanceRemainingIcon: Int) = apply {
         ...
         * @return Builder
         */
        fun estimatedArrivalTimeIcon(@DrawableRes estimatedArrivalTimeIcon: Int) = apply {
         ...
         * @return Builder
         */
        fun timeRemainingTextAppearance(@StyleRes timeRemainingTextAppearance: Int) = apply {
         ...
         * @return Builder
         */
        fun distanceRemainingTextAppearance(@StyleRes distanceRemainingTextAppearance: Int) =
            apply {
         ...
         * @return Builder
         */
        fun estimatedArrivalTimeTextAppearance(@StyleRes estimatedArrivalTimeTextAppearance: Int) =
            apply {
         ...
         * @return Builder
         */
        fun distanceRemainingIconTint(distanceRemainingIconTint: ColorStateList?) = apply {
         ...
         * @return Builder
         */
        fun estimatedArrivalTimeIconTint(estimatedArrivalTimeIconTint: ColorStateList?) = apply {
