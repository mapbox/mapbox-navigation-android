...
// import com.mapbox.navigation.route.onboard.task.ConfigureRouterTask
// import com.mapbox.navigation.route.onboard.task.OfflineRouteRetrievalTask
// import com.mapbox.navigation.route.onboard.task.RemoveTilesTask
// import com.mapbox.navigator.Navigator
//
// internal interface OfflineNavigator {
//
//     /**
...
//     )
//
//     class OfflineNavigatorImpl(private val navigator: Navigator): OfflineNavigator {
//
//         override fun configure(tilePath: String, callback: OnOfflineTilesConfiguredCallback) {
//             ConfigureRouterTask(navigator, tilePath, callback).execute()
//         }
//
//         override fun retrieveRouteFor(offlineRoute: OfflineRoute, callback: OnOfflineRouteFoundCallback) {
//             OfflineRouteRetrievalTask(navigator, callback).execute(offlineRoute)
//         }
//
//         override fun unpackTiles(tarPath: String, destinationPath: String) {
