...
import com.mapbox.navigation.utils.NavigationConstants
import com.mapbox.navigation.utils.NavigationConstants.ROUNDING_INCREMENT_FIFTY
...
data class MapboxNavigationOptions(
    ...
    class Builder {
        ...
        fun navigationLocationEngineIntervalLagInMilliseconds(lagInMilliseconds: Int) = apply {
            this.navigationLocationEngineIntervalLagInMilliseconds = lagInMilliseconds
        }
