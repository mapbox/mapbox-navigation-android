...
import com.mapbox.services.android.navigation.testapp.activity.OffboardRouterActivity;
...
public class MainActivity extends AppCompatActivity implements PermissionsListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final List<SampleItem> samples = new ArrayList<>(Arrays.asList(
      ...
      new SampleItem(
        getString(R.string.title_offboard_router),
        getString(R.string.description_offboard_router),
        OffboardRouterActivity.class
      ),
      new SampleItem(
