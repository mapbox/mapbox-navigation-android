...
public class OfflineRerouteActivity extends AppCompatActivity implements OnMapReadyCallback, LocationEngineListener,
  ...
  private MapboxOfflineNavigation offlineRouting;
  ...
  public void onMapReady(MapboxMap mapboxMap) {
    ...
    offlineRouting = new MapboxOfflineNavigation();
  ...
  public void userOffRoute(Location location) {
    ...
    offlineRouting.findOfflineRoute(offlineRoute, result -> handleNewRoute(route));
  }
