...
public abstract class BaseNavigationViewActivityTest {
  ...
  private static final int TIMEOUT_TWENTY_MINUTES = 20;
  ...
  public void beforeTest() {
    try {
      IdlingPolicies.setMasterPolicyTimeout(TIMEOUT_TWENTY_MINUTES, TimeUnit.MINUTES);
      IdlingPolicies.setIdlingResourceTimeout(TIMEOUT_TWENTY_MINUTES, TimeUnit.MINUTES);
