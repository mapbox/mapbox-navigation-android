...
import com.mapbox.services.android.navigation.testapp.action.WaitAction;
import com.mapbox.services.android.navigation.testapp.utils.OnNavigationReadyIdlingResource;
...
public abstract class BaseNavigationActivityTest {
  ...
  public void beforeTest() {
    try {
      ...
      mapboxMap = idlingResource.getNavigationView().retrieveMapboxMap();
